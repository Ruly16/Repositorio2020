...
public class Juego extends Application{
	...
	public void start(Stage ventana) throws Exception {
		...
		ventana.setTitle("Proyecto Genial Ruly");
		ventana.show();
		cicloJuego();
	}
	...
	public void inicializarComponentes() {
		...
		jugadorAnimado = new JugadorAnimado(20, 250, "ninja", 3, 0,"descanso");
		fondo = new Fondo(0,0,"fondo1","fondo1",7);
		inicializarTiles();
		item = new Item(200,355, "item1",0, 1);
		item1 = new Item(250,355, "item2",0, 1);
		item2 = new Item(300,355, "item",0, 1);
	...
	public void cargarImagenes() {
		...
		imagenes.put("ninja",new Image("ninja.png"));
		imagenes.put("item1", new Image("itemspuntos.png"));
		imagenes.put("item2", new Image("itemsvida.png"));
	}

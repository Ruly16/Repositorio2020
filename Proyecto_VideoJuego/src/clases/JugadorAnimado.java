...
public class JugadorAnimado extends ObjetoJuego{
	...
	public void inicializarAnimaciones() {
		Rectangle coordenadasCorrer[]= {
				...
				//Mis Animaciones Correr
				new Rectangle(3,214,    190,160),
				new Rectangle(200,214,  190,160),
				new Rectangle(395,214,  190,160),
				new Rectangle(590,214,  190,160),
				new Rectangle(785,214,  190,160),
				new Rectangle(980,214,  190,160),
				new Rectangle(1175,214, 190,160),
				new Rectangle(1370,214, 190,160),
				new Rectangle(1565,214, 190,160),
				new Rectangle(1760,214, 190,160)
		};
		...
		Rectangle coordenadasDescanso[] = {
				/*new Rectangle(26, 16, 62,72),
				new Rectangle(89,16, 62,72),
				new Rectangle(153,16, 62,72),
				new Rectangle(225,16, 62,72)*/
				
				//Mis Animaciones Descanso
				new Rectangle(45,15,   190,130),
				new Rectangle(230,15,  190,130),
				new Rectangle(427,15,  190,130),
				new Rectangle(620,15,  190,130),
				new Rectangle(810,15,  190,130),
				new Rectangle(1008,15, 190,130),
				new Rectangle(1200,15, 190,130),
				new Rectangle(1400,15, 190,130),
				new Rectangle(1584,15, 190,130),
				new Rectangle(1776,15, 190,130)
		};
